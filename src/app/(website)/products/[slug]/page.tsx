  ...
  return (
    <main className="min-h-screen bg-gray-50 dark:bg-gray-950 pt-24 pb-16">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <Link
          href="/products"
          className="inline-flex items-center text-gray-600 dark:text-gray-400 hover:text-[#CE1117] transition-colors mb-8"
        >
            ...
            <div className="p-8 lg:p-12 flex flex-col justify-center">
              ...
              <div className="pt-6 border-t border-gray-100 dark:border-gray-700">
                ...
                <p className="text-xs text-gray-500 dark:text-gray-400 mt-4">
                  Secure payment via Razorpay. Instant download link provided
                  after purchase.
                </p>
              </div>
            </div>
